...
'address' => '\Goletter\AmazonSellingPartnerAPI\Models\Services\Address',    ];
...
self::SERVICE_LOCATION_TYPE_ONLINE,        ];
     ...
     * Gets address.
     *
     * @return \Goletter\AmazonSellingPartnerAPI\Models\Services\Address
     */
     ...
     * Sets address.
     *
     * @param \Goletter\AmazonSellingPartnerAPI\Models\Services\Address $address address
     *
     * @return $this
     */
