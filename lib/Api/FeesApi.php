...
use Goletter\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateResponse;
...
class FeesApi
{
     ...
     *
     * @param \Goletter\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateRequest $body body (required)
     * @param string                                                                        $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     *
     * @throws \InvalidArgumentException
     * @throws \Goletter\AmazonSellingPartnerAPI\ApiException on non-2xx response
     *
     * @return \Goletter\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateResponse
     */
     ...
     *
     * @param \Goletter\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateRequest $body (required)
     * @param string                                                                        $asin The Amazon Standard Identification Number (ASIN) of the item. (required)
     *
     * @throws \InvalidArgumentException
     * @throws \Goletter\AmazonSellingPartnerAPI\ApiException on non-2xx response
     *
     * @return array of \Goletter\AmazonSellingPartnerAPI\Models\ProductFees\GetMyFeesEstimateResponse, HTTP status code, HTTP response headers (array of strings)
     */
